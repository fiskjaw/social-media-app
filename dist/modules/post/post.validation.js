...
exports.Updatepostschema = exports.likeUnlikeschema = exports.createpostschema = void 0;
...
exports.Updatepostschema = {
    ...
    body: zod_1.default.strictObject({
        ...
        availability: zod_1.default.enum(post_model_1.availabilityEnum).default(post_model_1.availabilityEnum.PUBLIC),
        tags: zod_1.default.array(validation_middleware_1.generalfields.id).max(5).optional(),
        removetags: zod_1.default.array(validation_middleware_1.generalfields.id).max(10).optional(),
        removeattachments: zod_1.default.array(zod_1.default.string()).max(50).optional(),
    }).superRefine((data, ctx) => {
        if (!data.attachments?.length && !data.content) {
            ctx.addIssue({
                code: "custom",
